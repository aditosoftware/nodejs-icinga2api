...
// icingaServer.getServiceTemplates(function(err, result){
//     if(err){
//         console.log(err);
//     } else {
//         console.log(result);
...
// icingaServer.getHostTemplates(function(err, result){
//   if(err){
//       console.log(err); 
//   } else {
//       console.log(result);
...
// icingaServer.checkExistServiceTemplate('generic-service', function(err, result){
//     if(err){
//         console.log(err);
//     } else {
//         console.log(result);
...
icingaServer.checkExistHostTemplate('generic-host', function(err, result){
    if(err){
        console.log(err)
    } else {
        console.log(result);
